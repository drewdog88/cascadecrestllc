...
| `npm run process-logo` | Build transparent logos from `CascadeCrest.png` into `public/images/logo/` |
| `npm run extract-logo` | Crop logos from `design/gemini-logo-sheet.png` (legacy 4-up sheet) |
...
app/                    Layout, home page, globals.css, metadata routes
  ...
  compliance/           Oregon / Portland compliance checklist
...
scripts/
  ...
  process-logo.mjs      Transparent wordmark/icon from CascadeCrest.png
